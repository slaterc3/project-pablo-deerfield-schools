...
#
# Usage:
#   python run.py --pdf surveys.pdf --template template.xlsx
#   python run.py --pdf surveys.pdf --template template.xlsx --survey-type weld_re1
